...
class StreamParser extends stream.Writable {
    ...
    write(input, isLast = false) {
        ...
        while (localPosition < end) {
            if (input[localPosition] !== "<") {
                ...
                if (nextTag === -1) {
                    ...
                    if (isLast) {
                        ...
                        this.stalled = 'TEXT';
                        this.lastInput = input.slice(localPosition);
                    }
                    break;
                }
            ...
            //         this.emit(
            //             "error",
            //             new Error("Unclosed processing instruction")
            //         );
            //         break;
            //     }
            ...
            if (tagClose === -1) {
                this.stalled = 'TAGOPEN';
                this.lastInput = input.slice(localPosition - 1);
